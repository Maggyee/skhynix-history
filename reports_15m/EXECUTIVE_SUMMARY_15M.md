...
7. 五家原生15分钟成交收盘价严格共同窗口：`[2026-06-10 06:00:00+00:00, 2026-07-24 04:15:00+00:00)`，共同闭合桶 4,176 个。
8. 15m trade-close P95 前三：gate/hyperliquid 247.74 bps; gate/okx 219.60 bps; binance/gate 203.00 bps。P99 前三：gate/hyperliquid 333.00 bps; gate/okx 280.33 bps; binance/gate 242.26 bps。
9. 15m 价格+资金联合策略窗口的成本结果：
- 20 bps触发阈值＋双所总往返成本 20 bps：1638 个已实现事件，正收益 219，累计事件净值 -17810.81 bps。
- 20 bps触发阈值＋双所总往返成本 40 bps：1638 个已实现事件，正收益 36，累计事件净值 -50570.81 bps。
- 20 bps触发阈值＋双所总往返成本 80 bps：1638 个已实现事件，正收益 7，累计事件净值 -116090.81 bps。
10. Gate 在 7月16日前已有原生15m数据；相关组合此前绝对价差 P95/P99/最大为 222.61/280.54/449.76 bps，因此可直接检查异常溢价是否早已存在。
11. Hyperliquid 在7月19日前已有原生15m trade 数据；相对其他交易所的有向价差中位/P95/P99为 44.74/199.76/260.28 bps（符号随 pair 字母顺序，精确组合见 CSV）。
