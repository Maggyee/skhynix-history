.PHONY: quick corrected-history analysis-15m gate-regime-15m analysis-1m-zero-convergence duration-fix collect-1m monitor-1m report-live-1m test
quick:
...
analysis-1m-zero-convergence:
	mkdir -p reports_1m_zero_convergence/charts
	uv run python -m skhynix_research.native_1m_zero_convergence
