...
**截止 UTC：2026-07-23 09:19:00+00:00**。本报告仅用于近期尖峰、分钟事件持续时间与局部 regime；Gate 1m 从 2026-07-16 18:34 开始，Hyperliquid 1m 从 2026-07-19 16:05 开始，五家共同窗口很短。不得用于 2026-06-10 起的五家全历史价格或资金排名；全历史主结论见 `reports_15m/EXECUTIVE_SUMMARY_15M.md`。旧非同窗榜仅作 `NOT_COMPARABLE` 审计。
...
4. Gate regime 分段结果：
- binance/gate: 全共同窗口=130.80/179.24/189.72；regime=171.17/181.87/189.72；排除后=18.79/26.92/56.53；7月20日后=18.79/26.92/56.53 bps
- bitget/gate: 全共同窗口=106.05/176.19/189.13；regime=170.28/179.08/189.13；排除后=20.81/25.28/47.73；7月20日后=20.81/25.29/47.73 bps
- gate/hyperliquid: 全共同窗口=65.99/80.59/100.24；regime=85.46/89.65/100.24；排除后=43.23/49.32/78.56；7月20日后=43.23/49.32/78.56 bps
...
- binance/bitget: price `[2026-06-10 05:50:00+00:00, 2026-07-23 09:07:00+00:00)`，有效 62,117 分钟，覆盖 100.00%
- binance/gate: price `[2026-07-16 18:34:00+00:00, 2026-07-23 09:08:00+00:00)`，有效 9,514 分钟，覆盖 100.00%
- binance/hyperliquid: price `[2026-07-19 16:05:00+00:00, 2026-07-23 09:08:00+00:00)`，有效 5,343 分钟，覆盖 100.00%
- binance/okx: price `[2026-06-10 05:50:00+00:00, 2026-07-23 07:04:00+00:00)`，有效 61,994 分钟，覆盖 100.00%
- bitget/gate: price `[2026-07-16 18:34:00+00:00, 2026-07-23 09:07:00+00:00)`，有效 9,513 分钟，覆盖 100.00%
- bitget/hyperliquid: price `[2026-07-19 16:05:00+00:00, 2026-07-23 09:07:00+00:00)`，有效 5,342 分钟，覆盖 100.00%
- bitget/okx: price `[2026-06-10 05:50:00+00:00, 2026-07-23 07:04:00+00:00)`，有效 61,994 分钟，覆盖 100.00%
- gate/hyperliquid: price `[2026-07-19 16:05:00+00:00, 2026-07-23 09:08:00+00:00)`，有效 5,343 分钟，覆盖 100.00%
...
5. 8小时固定持有的历史代理路径在成本情景下：20 bps：funding_optimal_trailing_24h: 1228/6760 (18.17%)；price_convergence: 1599/6760 (23.65%)；40 bps：funding_optimal_trailing_24h: 433/6760 (6.41%)；price_convergence: 537/6760 (7.94%)；80 bps：funding_optimal_trailing_24h: 104/6760 (1.54%)；price_convergence: 119/6760 (1.76%)。这是分钟代理规则集合，不是可执行利润。
...
- 价格收敛方向与仅用入场前24小时资金事件选出的方向，按8小时样本入场的一致率：一致/多数一致 gate/hyperliquid(65.2%), gate/okx(65.4%), binance/gate(84.5%), bitget/gate(88.1%), hyperliquid/okx(92.1%)；冲突/多数冲突 bitget/okx(21.8%), binance/okx(35.5%), binance/hyperliquid(43.2%), bitget/hyperliquid(44.2%), binance/bitget(49.4%)。Binance/OKX 与 Bitget/OKX 的冲突最明显。
...
- 跨 pair 的 session P95 中位数最高是 `US_PREMARKET`；20 bps事件在1小时内严格回到20 bps以下的完整观测比例最高的时段为 KRX_CLOSE_TRANSITION=100.00%, KRX_HOLIDAY_OR_WEEKEND=99.41%, US_AFTER_HOURS=99.23%, KRX_REGULAR_EARLIER=99.20%；这不是Kaplan–Meier无偏概率。Long Bitget/Short OKX 资金贡献最高时段为 `KRX_REGULAR_EARLIER`（$331.93/$10,000）。
...
- 20 bps唯一 `base_event` 共 **4816** 个：完成 4812，右删失 4，数据缺口删失 0。修正前20 bps市场事件也是 4810 个（数量差 +6），但旧表没有删失状态和稳定ID；策略方向、退出规则和成本不再进入持续时间计数。
- 已观测持续时间中位数/P75/P90/P95/P99：**2.0/7.0/26.0/61.2/442.6 分钟**。
- 仅已完成事件在5/15/30/60/240分钟内结束的比例：70.07%/86.03%/91.50%/94.97%/98.23%；全部已观测事件中超过1天 14 个。
- 最长事件：bitget/okx，`[2026-06-19 08:22:00+00:00, 2026-06-25 07:00:00+00:00]`，已观测 8559 分钟，状态 COMPLETED，开始regime=PRE_GATE_REGIME；删失事件不称为完整真实持续时间。
- Gate regime相关事件中位数/P95：4.0/233.4 分钟；7月20日后：2.0/51.4 分钟。

### 初步结论

- 排除Gate regime后，P95=58.0、P99=404.2、最长已观测=8559分钟，说明长尾是否仍存在应以这些数字判断，而不是由旧全范围直方图目测。
